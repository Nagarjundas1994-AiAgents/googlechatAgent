...
echo ""
echo "🌐 Your AI Agent is now deployed at: https://ai-agent-nzhkpa3xwa-uc.a.run.app/"
echo ""
...
echo "3. Set up webhook URL: https://ai-agent-nzhkpa3xwa-uc.a.run.app/webhook"
...
echo "2. Upload initial documents through the web interface: https://ai-agent-nzhkpa3xwa-uc.a.run.app/"
